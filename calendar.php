...
<head>
  ...
  <link rel="stylesheet" href="./fullCalendarCss/style.css">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div id="external-events">
                    <div class="external-event bg-success">Beginner</div>
                    <div class="external-event bg-warning">Elementry</div>
                    <div class="external-event bg-info">Pre Intermadite</div>
                    <div class="external-event bg-primary">Intermadite</div>
                    <div class="external-event bg-danger">Advanced</div>
                    <div class="checkbox">
